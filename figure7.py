...
def time_vs_probabilities_classical():
    print("Suppose d>n")
    ...
    list_p_seen_true = [0.99, 0.95, 0.9, 0.8, 0.7, 0.6, 0.5, 0.4, 0.3, 0.2, 0.1, 0.01]
    #list_p_seen_true = [0.95, 0.75, 0.35, 0.15]
    ...
    X_orig = np.random.standard_normal(size=(n, d))
    print(X_orig.dtype)
    print("max min ")
    ...
    for r in range(rep):
        ...
        for k, p_k in enumerate(list_p_seen_true):
            ...
            print("2 * n * p1 * (1-p1) (avr nbr of flips):   ", 2 * n * p_k * (1-p_k))
    ...
    folder = Path("results/experiment_7")
    folder.mkdir(parents=True, exist_ok=True)
    np.save("results/experiment_7/time_my_array.npy", time_my_array)
    np.save("results/experiment_7/time_skl_array.npy", time_skl_array)
    np.save("results/experiment_7/list_p_seen_true.npy", np.array(list_p_seen_true))
    np.save("results/experiment_7/size.npy", np.array([n]))
    np.save("results/experiment_7/dim.npy", np.array([d]))
    np.save("results/experiment_7/R.npy", np.array([R]))
    np.save("results/experiment_7/rep.npy", np.array([rep]))
    np.save("results/experiment_7/exp_d.npy", np.array([exp_d]))



def plot_fig_7():

    list_p_seen_true = np.load("results/experiment_7/list_p_seen_true.npy")
    time_my_array = np.load("results/experiment_7/time_my_array.npy")
    time_skl_array = np.load("results/experiment_7/time_skl_array.npy")
    n = np.load("results/experiment_7/size.npy")
    d = np.load("results/experiment_7/dim.npy")
    R = np.load("results/experiment_7/R.npy")
    rep = np.load("results/experiment_7/rep.npy")
    exp_d = np.load("results/experiment_7/exp_d.npy")
    print(list_p_seen_true)
    ...
    print("p1 ", p1, " p2, ", p2)
    plt.axvline(x = p1, linestyle='--', linewidth=2)
    plt.axvline(x = p2, linestyle='--', linewidth=2)
...
time_vs_probabilities_classical()
plot_fig_7()
