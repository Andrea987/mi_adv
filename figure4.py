...
def time_vs_probabilities_missing():
    ...
    list_n = [200]  # increasing order
    list_d = [900]  # increasing order
...
def time_vs_probabilities_missing_cleaned():
    ...
    folder = Path("results/experiment_4")
    folder.mkdir(parents=True, exist_ok=True)
    np.save("results/experiment_4/time_my_array.npy", time_my_array)
    np.save("results/experiment_4/time_skl_array.npy", time_skl_array)
    np.save("results/experiment_4/list_p_seen_true.npy", np.array(list_p_seen_true))
    np.save("results/experiment_4/size.npy", np.array([n]))
    np.save("results/experiment_4/dim.npy", np.array([d]))
    np.save("results/experiment_4/R.npy", np.array([R]))
    np.save("results/experiment_4/rep.npy", np.array([rep]))
